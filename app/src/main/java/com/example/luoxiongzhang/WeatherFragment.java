...
public class WeatherFragment extends Fragment {
    TextView week_date,week_maxmintemp,week_describe,tv_sunrise,tv_sunset,tv_humidity,tv_pressure,tv_precip,tv_vis,tv_windSpeedDay,tv_uvIndex,tv_cloud;
            ...
            public void onSuccess(WeatherDailyBean weatherDailyBean) {
                if (Code.OK == weatherDailyBean.getCode()) {
                    ...
                    getActivity().runOnUiThread(new Runnable(){
                        @Override
                        public void run() {
                            week_date.setText(now.get(position).getFxDate());
