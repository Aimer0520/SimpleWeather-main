...
public class MainActivity extends AppCompatActivity {
    ...
    CardView cv_pm25,cv_AQL, cv_weather1, cv_weather2;
    ImageView tv_today_icon, tv_tomorrow_icon, add_city;
    TextView tv_pm25,tv_date,tv_city, tv_temp, tv_case, tv_explain1, tv_explain2, tv_airRegime, tv_AQI, tv_today_maxmintemp, tv_today_case, tv_today_grade, tv_tomorrow_manmintemp, tv_tomorrow_case, tv_tomorrow_grade;
...
//            Log.d(TAG, "getCity: "+getIntent().getSerializableExtra("City"));
            tv_city.setText(city_list.getCity()+" "+city_list.getArea());
        } else {
...
//            Log.d(TAG, "getCity: "+city_list.toString());
    ...
    private void ViewInitialize() {
        ...
        cv_pm25 = findViewById(R.id.cv_pm25);
        ...
        //增加CardView卡片透明度
        cv_pm25.getBackground().setAlpha(40);
...
//                            Log.d(TAG, "run: "+now.getText());
                            ...
                            tv_date.setText(now.getObsTime());
                ...
                if (Code.OK == airNowBean.getCode()) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            tv_pm25.setText("PM：" + nowair.getPm2p5() + "μg/m3");
                        }
                    });
                } else {
                    //在此查看返回数据失败的原因
